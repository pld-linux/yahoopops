...
Summary(pl.UTF-8):	YPOPs! - emulacja serwera pocztowego POP3/SMTP i swobodny dostęp do Yahoo! Mail
Name:		yahoopops
Version:	0.6
Release:	0.3
...
YPOPs! to aplikacja dająca dostęp POP3 do usługi Yahoo! Mail. Jest
dostępna na platformach Windows, Linux, Solaris i Mac.

Yahoo! Mail wyłączył swobodny dostęp do usługi POP3 24 kwietnia 2002.
Ta aplikacja emuluje serwer POP3 i umożliwia popularnym klientom
pocztowym, takim jak Outlook, Netscape, Eudora, Mozilla itp. ściąganie
poczty z kont Yahoo!. Ten program nie jest sprzeczny z licencją Yahoo!
Mail, aplikacja jest w pełni legalna.

Jak to działa? Aplikacja działa bardziej jako bramka. Dostarcza
interfejs serwera POP3 z jednej strony w celu komunikacji z klientami
pocztowymi oraz interfejs klienta HTTP ("przeglądarkę") z drugiej w
celu komunikacji z Yahoo!.

YPOPs! był zainspirowany skryptem Perla o nazwie FetchYahoo napisanym
